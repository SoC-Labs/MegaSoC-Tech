...
(
  ...
  L1_tlb u_tlb_bank0 (
                                  .CLK       (clk),
                                  .A         (tlb_ram_addr_i),
                                  .Q         ({{(u_tlb_bank_o_UNCONNECTED[0])},{tlb_ram_rdata0_o[`CA53_TLB_RAM_W-1:0]}}),
                                  .D         ({{(u_tlb_bank_i_UNCONNECTED[0])},{tlb_ram_wdata_i[`CA53_TLB_RAM_W-1:0]}}),
                                  .CEN       (~tlb_ram_en_i[0]),
                                  .GWEN       (~tlb_ram_wr_i),
                                  .EMA       (3'b111),
                                  .EMAW      (2'b11),
  ...
  L1_tlb u_tlb_bank1 (
                                  .CLK       (clk),
                                  .A         (tlb_ram_addr_i),
                                  .Q         ({{(u_tlb_bank_o_UNCONNECTED[1])},{tlb_ram_rdata1_o[`CA53_TLB_RAM_W-1:0]}}),
                                  .D         ({{(u_tlb_bank_i_UNCONNECTED[1])},{tlb_ram_wdata_i[`CA53_TLB_RAM_W-1:0]}}),
                                  .CEN       (~tlb_ram_en_i[1]),
                                  .GWEN       (~tlb_ram_wr_i),
                                  .EMA       (3'b111),
                                  .EMAW      (2'b11),
  ...
  L1_tlb u_tlb_bank2 (
                                  .CLK       (clk),
                                  .A         (tlb_ram_addr_i),
                                  .Q         ({{(u_tlb_bank_o_UNCONNECTED[2])},{tlb_ram_rdata2_o[`CA53_TLB_RAM_W-1:0]}}),
                                  .D         ({{(u_tlb_bank_i_UNCONNECTED[2])},{tlb_ram_wdata_i[`CA53_TLB_RAM_W-1:0]}}),
                                  .CEN       (~tlb_ram_en_i[2]),
                                  .GWEN       (~tlb_ram_wr_i),
                                  .EMA       (3'b111),
                                  .EMAW      (2'b11),
  ...
  L1_tlb u_tlb_bank3 (
                                  .CLK       (clk),
                                  .A         (tlb_ram_addr_i),
                                  .Q         ({{(u_tlb_bank_o_UNCONNECTED[3])},{tlb_ram_rdata3_o[`CA53_TLB_RAM_W-1:0]}}),
                                  .D         ({{(u_tlb_bank_i_UNCONNECTED[3])},{tlb_ram_wdata_i[`CA53_TLB_RAM_W-1:0]}}),
                                  .CEN       (~tlb_ram_en_i[3]),
                                  .GWEN       (~tlb_ram_wr_i),
                                  .EMA       (3'b111),
                                  .EMAW      (2'b11),
