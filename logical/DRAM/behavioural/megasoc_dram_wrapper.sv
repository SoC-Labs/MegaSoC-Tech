...
generate
    if(USE_SYNOPSYS_DDR_CTRL) begin : g_snps_ddr_ctrl
...
//--------------------------------------------------------------------------------
        ...
        assign DRAM_CFG_APB.pready = 1'b1;
        assign DRAM_CFG_APB.pslverr = 1'b0;
        assign DRAM_CFG_APB.prdata = 32'hEADBEEF;
        assign DRAM_PHY_CFG_APB.pready = 1'b1;
        assign DRAM_PHY_CFG_APB.pslverr = 1'b0;
        assign DRAM_PHY_CFG_APB.prdata = 32'hEADBEEF;
    end
endgenerate
