...
wire                    SDIO_IRQ;
wire                    dram_PHY_IRQ;
wire                    dram_ecc_corrected_err_intr;
wire                    dram_ecc_corrected_err_intr_fault;
wire                    dram_ecc_uncorrected_err_intr;
wire                    dram_ecc_uncorrected_err_intr_fault;
wire                    dram_dfi_alert_err_intr;
wire                    dram_derate_temp_limit_intr;
wire                    dram_derate_temp_limit_intr_fault;

assign CPU_IRQS={
    {(NUM_SPIS-99){1'b0}},
    4'h0, // reserved for ethernet
    dram_PHY_IRQ,
    dram_ecc_corrected_err_intr,
    dram_ecc_corrected_err_intr_fault,
    dram_ecc_uncorrected_err_intr,
    dram_ecc_uncorrected_err_intr_fault,
    dram_dfi_alert_err_intr,
    dram_derate_temp_limit_intr,
    dram_derate_temp_limit_intr_fault,
    SDIO_IRQ,
    EXP_IRQs,
    QSPI_IRQ,
    PERI_IRQS,
...
dram_wrapper #(.ID_W(8)) u_megasoc_dram_wrapper(
    .ACLK(SYS_CLK),
    .ARESETn(SYS_RESETn),
    ...
    .PHY_IRQ(dram_PHY_IRQ),
    .ecc_corrected_err_intr(dram_ecc_corrected_err_intr),
    .ecc_corrected_err_intr_fault(dram_ecc_corrected_err_intr_fault),
    .ecc_uncorrected_err_intr(dram_ecc_uncorrected_err_intr),
    .ecc_uncorrected_err_intr_fault(dram_ecc_uncorrected_err_intr_fault),
    .dfi_alert_err_intr(dram_dfi_alert_err_intr),
    .derate_temp_limit_intr(dram_derate_temp_limit_intr),
    .derate_temp_limit_intr_fault(dram_derate_temp_limit_intr_fault),
